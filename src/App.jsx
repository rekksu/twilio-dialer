...
export default function OrbitPhone({ twilioNumbers }) {
  ...
  // --- Enable Audio + Initialize Twilio Device ---
  ...
  const startOutboundCall = async () => {
    if (!selectedNumber || !dialTo) return setStatus("❌ Missing numbers");

    // Call the outbound cloud function
    try {
